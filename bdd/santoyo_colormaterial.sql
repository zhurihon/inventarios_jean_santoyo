...
--
-- Table structure for table `colormaterial`
--
...
CREATE TABLE `colormaterial` (
  `colormaterial` varchar(32) NOT NULL,
  PRIMARY KEY (`colormaterial`)
...
LOCK TABLES `colormaterial` WRITE;
/*!40000 ALTER TABLE `colormaterial` DISABLE KEYS */;
INSERT INTO `colormaterial` VALUES ('blanco'),('Jeans');
...
-- Dump completed on 2024-11-27 21:28:36
